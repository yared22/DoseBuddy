    ...
    public static class DrugResult {
        ...
        public DrugInfo toDrugInfo() {
            ...
            if (openfda != null) {
                ...
                if (openfda.brand_name != null && !openfda.brand_name.isEmpty()) {
                    drugInfo.setBrandName(openfda.brand_name.get(0));
                }

                // Set generic name (first one if multiple)
                if (openfda.generic_name != null && !openfda.generic_name.isEmpty()) {
                    drugInfo.setGenericName(openfda.generic_name.get(0));
                }

                // Set manufacturer (first one if multiple)
                if (openfda.manufacturer_name != null && !openfda.manufacturer_name.isEmpty()) {
                    drugInfo.setManufacturer(openfda.manufacturer_name.get(0));
                }
            }
